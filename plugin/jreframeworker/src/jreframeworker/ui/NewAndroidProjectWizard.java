...
public class NewAndroidProjectWizard extends Wizard implements INewWizard {
	...
	private NewAndroidProjectPage page;

	public NewAndroidProjectWizard(String startAndroidPath) {
		page = new NewAndroidProjectPage("Create JReFrameworker Android Project");
		String projectName = new File(startAndroidPath).getName();
		...
		this.setWindowTitle("Create JReFrameworker Android Project");
	}
	...
	public boolean performFinish() {
		...
		final File targetAPK = page.getTargetAPK();
		...
		IRunnableWithProgress j = new IRunnableWithProgress() {
			...
			public void run(IProgressMonitor monitor) {
				IStatus result = null;
				try {
					result = JReFrameworker.createAndroidProject(projectName, projectLocation, monitor, targetAPK);
				} catch (Throwable t) {
					String message = "Could not create JReFrameworker Android project. " + t.getMessage();
